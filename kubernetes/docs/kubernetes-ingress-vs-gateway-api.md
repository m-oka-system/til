...
> Kubernetes における外部トラフィック管理の 2 つのアプローチを徹底比較
...
| メリット         | 説明                                             |
| ---------------- | ------------------------------------------------ |
| **シンプルさ**   | 1 つのリソースで HTTP ルーティングを定義可能     |
...
| シナリオ                      | 推奨             | 理由                              |
| ----------------------------- | ---------------- | --------------------------------- |
| **新規 Web アプリケーション** | Gateway API      | 将来性、標準化された API          |
...
> **Gateway API は Ingress の後継として設計された、より表現力豊かで拡張可能な API です。**
>
